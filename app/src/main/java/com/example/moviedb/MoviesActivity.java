...
public class MoviesActivity extends AppCompatActivity {
    ...
    private void databaseFillup(){
        ...
        if(databases.size() == 0) {
            ...
            Database database = new Database("Deadpool", "Ajax, a twisted scientist, experiments on Wade Wilson, a mercenary, to cure him of cancer and give him healing powers. However, the experiment leaves Wade disfigured and he decides to exact revenge.", "Tim Miller", "109min", "Ryan Reynolds, Morena Baccarin, T.J Miller", "action", "sa-KE1SJ2As");
            database.save();
            database = new Database("Forrest Gump", "Forrest, a man with low IQ, recounts the early years of his life when he found himself in the middle of key historical events. All he wants now is to be reunited with his childhood sweetheart, Jenny.", "Robert Zemeckis", "142min", "Tom Hanks, Robin Wright, Gary Sinise", "romance", "TnRxdap5UJ0s");
            database.save();
            database = new Database("Suicide Squad", "The government sends the most dangerous supervillains in the world -- Bloodsport, Peacemaker, King Shark, Harley Quinn and others -- to the remote, enemy-infused island of Corto Maltese. Armed with high-tech weapons, they trek through the dangerous jungle on a search-and-destroy mission, with only Col. Rick Flag on the ground to make them behave.", "James Gunn", "133min", "Margot Robbie, John Cena, Pete Davidson", "action", "Ht25E2_WNHE");
            database.save();
